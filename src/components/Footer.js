    ...
    return (
        <div className='bg-white mt-10'>
           <div className='container mx-auto px-4 md:px-0'>
            <div className='grid md:grid-cols-2  lg:grid-cols-4 xl:grid-cols-5 md:gap-y-6 pt-40'>
                <section>
                ...
                <div className="flex items-center justify-center hidden xl:block h-20 w-20 pt-14"> 
